...
let getGame = () => {
  axios({
    method: 'get',
    url: 'https://overtureapp.com/api/games/5a1cdfb863746ab649278162', // Get ID from UI
    headers: {
      'Authorization': 'Bearer ' + localStorage.getItem('token')
    }
  })
...
let getUsers = () => {
  axios({
    method: 'get',
    url: 'https://overtureapp.com/api/users',
    headers: {
      'Authorization': 'Bearer ' + localStorage.getItem('token')
    }
  })
...
let getUser = () => {
  axios({
    method: 'get',
    url: 'https://overtureapp.com/api/users/593a2c245ee35676febbbf9e', // Get ID from UI
    headers: {
      'Authorization': 'Bearer ' + localStorage.getItem('token')
    }
  })
